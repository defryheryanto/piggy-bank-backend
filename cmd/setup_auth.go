...
func SetupAuthService(db *gorm.DB, userConfig *auth.UserConfigService) *auth.AuthService {
	...
	return auth.NewAuthService(userStorage, tokenService, encryptor, userConfig)
}
